...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['action']) && isset($_GET['id'])) {
        ...
        $sql = "UPDATE tblcarwashbooking SET status = :status WHERE id = :id";
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                      <h2>New Bookings</h2>
                        ...
                        <tbody>
<?php 
// Fetch only bookings with status 'New' or 'Pending'
...
if ($query->rowCount() > 0) {
    foreach ($results as $result) { ?>		
                          <tr>
                            ...
                            <td>
                                <a href="new-booking.php?action=accept&id=<?php echo htmlentities($result->bid); ?>" class="btn btn-success" onclick="return confirm('Are you sure you want to accept this booking?');">Accept</a>
                                <a href="new-booking.php?action=decline&id=<?php echo htmlentities($result->bid); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to decline this booking?');">Decline</a>
                            </td>
                          </tr>
<?php } 
} else { ?>
